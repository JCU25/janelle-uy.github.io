...
const projects = {
    "coding": {
        ...
        "ECD-DSA": {
            ...
            roles: [
                "Full Stack Developer  (Oct 2023 - Feb 2024)",
                "Model Trainer (Nov 2023 - Jan 2024)",
            ],
            tools: [
                {
                    name: "Python",
        ...
        "MMCM CCIS Website": {
            description: 'This is a project made by the Mapua Malayan Colleges Mindanao (MMCM) Computing Students Society (CSS) to allow students to compile their portfolio, and to get updates on school events.',
        ...
        "MMCM CCIS Discord Bot": {
            description: 'This discord bot was made to verify the enrollment status of students, and to assign roles and permissions to each student based on their year levels in the discord server of Mapua Malayan Colleges Mindanao, College of Computer and Information Science (CCIS).',
            img: "/assets/projects/proj-discord-icon.png",
            details: [
                // details shall be the "contributions" for the coding projects section
        ...
        "MCM Cup 2022 Mobile Legends Discord Bot": {
            description: 'This discord bot was made to verify, register, and grant roles and permissions to the participants of the MCM Cup 2022 Mobile Legends Competition based on their teams.',
            img: "/assets/projects/proj-discord-icon.png",
            details: [
                // details shall be the "contributions" for the coding projects section
        ...
        "Face Mask Detection": {
            description: 'This machine learning model was trained using YOLOv8 using a face mask dataset with 3 classes: (1) with mask, (2) without mask, (3) mask weared incorrect. This project was made in fulfillment of our machine learning course.',
            projectLink: "https://github.com/JCU25/Face-Mask-Detection-and-Counting",
            img: "/assets/projects/proj-machine-learning-icon.png",
            details: [
                // details shall be the "contributions" for the coding projects section
        ...
        "Waste Classification ": {
            description: 'This machine learning model was trained using YOLOv8 using the EE297_Project.v4i.yolov8 dataset from Roboflow Universe. This project was made in fulfillment of our machine learning course.',
